...
class SyncFile {
    static read_file(file_name: string) {
        try {
    ...
    static copy_file(target_file: string, destination_file: string) {
        try {
    ...
    static write_file(file_name: string, content: any) {
        try {
    ...
    static file_there(file_name: string) {
        try {
    ...
    static make_dir(dir_name: string) {
        try {
    ...
    static read_dir(dir_name: string) {
        try {
    ...
    static read_json(file_name: string) {
        try {
    ...
    static update_json(file_name: string, content: any) {
        try {
